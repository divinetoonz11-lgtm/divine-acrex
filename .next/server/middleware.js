...
/**
 * Protect /api/admin/* routes with:
 *  - x-admin-key check
 *  - Origin/Referer allowlist (CORS protection)
 *
 * Set env var ALLOWED_ADMIN_ORIGINS e.g.:
 * ALLOWED_ADMIN_ORIGINS=http://localhost:3000,https://yourproductiondomain.com
 *
 * If ALLOWED_ADMIN_ORIGINS not set, defaults to http://localhost:3000
 */ function getAllowedOrigins() {
    const raw = process.env.ALLOWED_ADMIN_ORIGINS || "http://localhost:3000";
...
function middleware(req) {
    ...
    if (url.startsWith("/api/admin")) {
        ...
        // normalize referer to origin if full url given
        let originOnly = origin;
        try {
            if (origin && origin.includes("://")) {
                originOnly = new URL(origin).origin;
            }
        } catch (e) {}
        if (!isOriginAllowed(originOnly)) {
        ...
        // For valid requests, allow and continue
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Cinder%20mohan%20singh%5Cdivine99acres_web&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL2FkbWluKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYXBpL2FkbWluLzpwYXRoKiJ9XQ%3D%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL2FkbWluKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYXBpL2FkbWluLzpwYXRoKiJ9XX0%3D!
